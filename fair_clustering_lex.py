...
def fair_clustering_lex(counter, initial_score_save, pred_save, cluster_centers_save,dataset, config_file, data_dir, num_clusters, deltas, max_points, L=0, p_acc=1.0, ml_model_flag=False,two_color_util=True,epsilon=0.0,alpha_POF=0,L_POF=-1):
    ...
    for delta in deltas:
        ...
        print('let us see the proportions')
        #print(fp_color_flag)
        print(fp_alpha)
        print(fp_beta)
