...
import timeit
from util.pof_util import relax_alpha_viol, relax_beta_viol, get_color_with_min_proportion, relax_util_viol, alpha_beta_array, get_util_value_two_color



def fair_partial_assignment_util(df, centers, initial_score, delta, color_proprtions, alpha, beta, color_flag, clustering_method, num_colors, L=0, epsilon=1/8, alpha_POF=10):
    ...
    if clustering_method == "kmeans" or clustering_method == "kmedian":
        ...
        return final_res, elapsed_time_nf, r_min, col_min, r_max, col_max
